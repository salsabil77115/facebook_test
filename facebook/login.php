...
<html>
   ...
   <title>Register Page </title>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        ...
        <link rel="stylesheet" type="text/css" href="register.css?version=10">
...
<div class="column" style="margin-top:100px;">
     <div class="form-box">
        ...
        <form id="login"class="inputs" action="do_login.php" onsubmit="return do_login(); " method="post">
...
<div id="myModal" class="modal">
  ...
  <hr class="new1">
  <form  action="singup.php" onsubmit="return do_signup(); " method="post">
